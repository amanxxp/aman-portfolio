...
export const DATA = {
  ...
  contact: {
    email: "amanpanwar1672@gmail.com",
    tel: "+918851927215",
    social: {
      GitHub: {
        name: "GitHub",
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/amanxp",
        icon: Icons.linkedin,
  ...
  education: [
    ...
    },
    {
      ...
      href: "https://www.rawalpublicschool.com",
      degree: "10+2 PCMC",
      logoUrl: "/rawal.png",
      start: "2009",
      end: "2021",
